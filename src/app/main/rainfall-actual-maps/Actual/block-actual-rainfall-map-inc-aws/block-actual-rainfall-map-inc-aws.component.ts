...
@Component({
  selector: 'app-block-actual-rainfall-map-inc-aws',
  templateUrl: './block-actual-rainfall-map-inc-aws.component.html',
  styleUrls: ['./block-actual-rainfall-map-inc-aws.component.css']
})
export class BlockActualRainfallMapIncAwsComponent implements AfterViewInit{
          ...
          this.http.get("assets/geojson/INDIA_BLOCK.json").subscribe((res: any) => {
              ...
              this.geoJsonLayer = L.geoJSON(res, {
                ...
                onEachFeature: (feature: any, layer: any) => {
                  ...
                  const id2 = feature.properties["block_code"];
                  const matchedData = this.findMatchingData(id2, block);
                  let rainfall: any;
