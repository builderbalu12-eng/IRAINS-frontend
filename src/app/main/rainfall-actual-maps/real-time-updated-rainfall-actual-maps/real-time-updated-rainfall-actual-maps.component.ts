...
@Component({
  selector: 'app-real-time-updated-rainfall-actual-maps',
  templateUrl: './real-time-updated-rainfall-actual-maps.component.html',
  styleUrls: ['./real-time-updated-rainfall-actual-maps.component.css']
})
export class RealTimeUpdatedRainfallActualMapsComponent {
      ...
      dropDownMonths = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
      ...
      async downloadMapData() {
        ...
        try {
          ...
          if(this.selectedMode.selectedMode == 'Unified'){
            await this.downlaodStatistics.updateanddownloadpdfCustom(this.fromDate, this.toDate);
          }else{
            await this.downlaodStatistics.updateanddownloadpdfFromDataEntryCustom(this.fromDate, this.toDate);
          }
