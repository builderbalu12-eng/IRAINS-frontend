...
@Component({
  ...
  styleUrls: ["./pan-india-region-actual.component.css"],
})
export class PanIndiaRegionActualComponent implements AfterViewInit {
  districtdatacum: any[] = [];
  StartDate: any;
  EndDate: any;
  countrydatacum: any;
  ...
  // category-breakdown sub-table for district (buildCategoryStats() N/A
  // here — same as the DISTRICT branch in rainfall-statistics.component.ts).
  // To revert to a map-only page: delete these fields, loadStats() below,
