...
@Component({
  selector: 'app-north-west-region-actual',
  templateUrl: './north-west-region-actual.component.html',
  styleUrls: ['./north-west-region-actual.component.css']
})
export class NorthWestRegionActualComponent implements AfterViewInit{
