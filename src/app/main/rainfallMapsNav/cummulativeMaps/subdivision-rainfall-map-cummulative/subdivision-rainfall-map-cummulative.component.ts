...
@Component({
  ...
  templateUrl: './subdivision-rainfall-map-cummulative.component.html',
  styleUrls: ['./subdivision-rainfall-map-cummulative.component.css']
})
export class SubdivisionRainfallMapCummulativeComponent {
      ...
      async downloadMapData() {
        ...
        try {
          ...
          if(this.selectedMode.selectedMode == 'Unified'){
            await this.downlaodStatistics.updateanddownloadpdfCustom(this.StartDate, this.EndDate);
          }else{
            await this.downlaodStatistics.updateanddownloadpdfFromDataEntryCustom(this.StartDate, this.EndDate);
          }
