...
@Component({
  ...
  styleUrls: ['./region-rainfall-map-cummulative.component.css']
})
export class RegionRainfallMapCummulativeComponent {
    ...
    // shared <app-rainfall-stats-panel>. No category-breakdown sub-table
    ...
    async downloadMapData() {
      ...
      try {
        ...
        if(this.selectedMode.selectedMode == 'Unified'){
          await this.regionStatisticsDownload.updateanddownloadpdfCustom(this.StartDate, this.EndDate);
        }else{
          await this.regionStatisticsDownload.updateanddownloadpdfFromDataEntryCustom(this.StartDate, this.EndDate);
    ...
    async loadStats() {
      ...
      try {
        await this.regionStatisticsDownload.updateandViewpdfFromDataEntryCustom(this.fromDate, this.toDate);
