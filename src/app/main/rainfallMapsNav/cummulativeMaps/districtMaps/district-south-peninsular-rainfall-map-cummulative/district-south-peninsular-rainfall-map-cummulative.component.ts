...
@Component({
  selector: 'app-district-south-peninsular-rainfall-map-cummulative',
  templateUrl: './district-south-peninsular-rainfall-map-cummulative.component.html',
  styleUrls: ['./district-south-peninsular-rainfall-map-cummulative.component.css']
})
export class DistrictSouthPeninsularRainfallMapCummulativeComponent {
      ...
      async downloadMapData() {
        ...
        try {
          ...
          if(this.selectedMode.selectedMode == 'Unified'){
            ...
            await this.downloadPdf$.updateanddownloadpdfCustom("4", this.FromDate, this.ToDate);
          }else{
            await this.downloadPdf$.updateanddownloadpdfFromDataEntryCustom("4", this.FromDate, this.ToDate);
          } 
