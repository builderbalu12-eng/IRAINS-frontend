...
@Component({
  selector: 'app-district-north-west-rainfall-map-cummulative',
  templateUrl: './district-north-west-rainfall-map-cummulative.component.html',
  styleUrls: ['./district-north-west-rainfall-map-cummulative.component.css']
})
export class DistrictNorthWestRainfallMapCummulativeComponent {
      ...
      async downloadMapData() {
        ...
        try {
          ...
          if(this.selectedMode.selectedMode == 'Unified'){
            ...
            await this.downloadPdf$.updateanddownloadpdfCustom("3", this.FromDate, this.ToDate);
          }else{
            await this.downloadPdf$.updateanddownloadpdfFromDataEntryCustom("3", this.FromDate, this.ToDate);
          }           
    ...
    formatDateForDisplay(date: Date): string {
      ...
      async loadStats() {
        ...
        try {
          await this.downloadPdf$.updateandViewpdfFromDataEntryCustom("3", this.fromDate, this.toDate);
