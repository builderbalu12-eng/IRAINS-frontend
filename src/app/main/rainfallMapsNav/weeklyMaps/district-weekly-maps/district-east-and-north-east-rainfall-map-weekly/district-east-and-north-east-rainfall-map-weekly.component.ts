...
@Component({
  selector: "app-district-east-and-north-east-rainfall-map-weekly",
  templateUrl:
    "./district-east-and-north-east-rainfall-map-weekly.component.html",
  styleUrls: [
    "./district-east-and-north-east-rainfall-map-weekly.component.css",
  ],
})
export class DistrictEastAndNorthEastRainfallMapWeeklyComponent {
  districtdatacum: any[] = [];
  StartDate: any;
  EndDate: any;
  countrydatacum: any;
  ...
  async loadStats() {
    ...
    try {
      ...
      const fromDate = dates[0];
      const toDate = dates[1];
      await this.downloadPdf$.updateandViewpdfFromDataEntryCustom("2", fromDate, toDate);
