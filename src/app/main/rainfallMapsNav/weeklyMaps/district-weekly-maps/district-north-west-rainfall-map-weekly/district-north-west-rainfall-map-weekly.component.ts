...
@Component({
  selector: 'app-district-north-west-rainfall-map-weekly',
  templateUrl: './district-north-west-rainfall-map-weekly.component.html',
  styleUrls: ['./district-north-west-rainfall-map-weekly.component.css']
})
export class DistrictNorthWestRainfallMapWeeklyComponent {
