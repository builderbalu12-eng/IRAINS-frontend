...
@Component({
  ...
  styleUrls: ["./district-central-india-rainfall-map-weekly.component.css"],
})
export class DistrictCentralIndiaRainfallMapWeeklyComponent {
  districtdatacum: any[] = [];
  StartDate: any;
  EndDate: any;
  countrydatacum: any;
  ...
  async loadStats() {
    ...
    try {
      ...
      const fromDate = dates[0];
      const toDate = dates[1];
      await this.downloadPdf$.updateandViewpdfFromDataEntryCustom("1", fromDate, toDate);
