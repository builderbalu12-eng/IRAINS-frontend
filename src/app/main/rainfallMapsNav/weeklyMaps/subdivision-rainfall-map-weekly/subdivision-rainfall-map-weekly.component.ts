...
@Component({
  selector: "app-subdivision-rainfall-map-weekly",
  templateUrl: "./subdivision-rainfall-map-weekly.component.html",
  styleUrls: ["./subdivision-rainfall-map-weekly.component.css"],
})
export class SubdivisionRainfallMapWeeklyComponent {
  ...
  constructor(
    ...
    // not fromDate/today (those aren't bound to anything in the template —
    // the actual picker is [(ngModel)]="selectedWeek").
