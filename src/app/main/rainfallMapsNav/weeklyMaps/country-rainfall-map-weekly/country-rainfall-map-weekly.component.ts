...
@Component({
  ...
  templateUrl: "./country-rainfall-map-weekly.component.html",
  styleUrls: ["./country-rainfall-map-weekly.component.css"],
})
export class CountryRainfallMapWeeklyComponent {
  countrydatacum: any[] = [];
