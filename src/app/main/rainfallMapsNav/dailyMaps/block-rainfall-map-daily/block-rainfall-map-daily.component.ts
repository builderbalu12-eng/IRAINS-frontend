...
@Component({
  selector: 'app-block-rainfall-map-daily',
  templateUrl: './block-rainfall-map-daily.component.html',
  styleUrls: ['./block-rainfall-map-daily.component.css']
})
export class BlockRainfallMapDailyComponent implements AfterViewInit{
    ...
    formatDate(date: Date): string {
      ...
      constructor(
        ...
        const initWithEffectiveDate = (effectiveDate: Date) => {
          ...
          // fetchBackend()'s request payload — both read fromDate/toDate. `today`
          // was previously never assigned anywhere in this component, so
          // [max]="today" had no effect at all.
