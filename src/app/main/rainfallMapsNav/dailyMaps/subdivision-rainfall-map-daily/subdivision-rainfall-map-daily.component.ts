...
@Component({
  selector: "app-subdivision-rainfall-map-daily",
  templateUrl: "./subdivision-rainfall-map-daily.component.html",
  styleUrls: ["./subdivision-rainfall-map-daily.component.css"],
})
export class SubdivisionRainfallMapDailyComponent {
  ...
  // table), rendered by the shared <app-rainfall-stats-panel>. To revert
  // to a map-only page: delete these fields, loadStats() below, and the
  ...
  async loadStats() {
    ...
    try {
      await this.downlaodStatistics.updateandViewpdfFromDataEntryCustom(this.fromDate, this.fromDate);
