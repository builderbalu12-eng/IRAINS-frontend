...
@Component({
  ...
  templateUrl: './east-north-east-region.component.html',
  styleUrls: ['./east-north-east-region.component.css']
})
export class EastNorthEastRegionComponent implements AfterViewInit{
