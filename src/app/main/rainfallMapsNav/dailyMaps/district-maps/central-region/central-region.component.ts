...
@Component({
  ...
  templateUrl: './central-region.component.html',
  styleUrls: ['./central-region.component.css']
})
export class CentralRegionComponent implements AfterViewInit{
     ...
     districtdatacum: any[] = [];
      ...
      private toggleLogoPosition(isFullscreen: boolean): void {
        ...
        const resetButton =
          this.elRef.nativeElement.querySelector("#resetButtonNavbar-central");
      ...
      const borderRemove = this.elRef.nativeElement.querySelector('#border-remove-central')
