...
@Component({
  selector: 'app-south-peninsulara-region',
  templateUrl: './south-peninsulara-region.component.html',
  styleUrls: ['./south-peninsulara-region.component.css']
})
export class SouthPeninsularaRegionComponent implements AfterViewInit{
      ...
      async downloadMapData() {
        ...
        try {
          ...
          if(this.selectedMode.selectedMode == 'Unified'){
            ...
            await this.downloadPdf$.updateanddownloadpdfCustom("4", this.fromDate, this.fromDate);
  
          }else{
            await this.downloadPdf$.updateanddownloadpdfFromDataEntryCustom("4", this.fromDate, this.fromDate);
          }        
      ...
      async loadStats() {
        ...
        try {
          await this.downloadPdf$.updateandViewpdfFromDataEntryCustom("4", this.fromDate, this.fromDate);
      ...
      private toggleLogoPosition(isFullscreen: boolean): void {
        ...
        const resetButton =
          this.elRef.nativeElement.querySelector("#resetButtonNavbar-south");
      ...
      const borderRemove = this.elRef.nativeElement.querySelector('#border-remove-south')
