...
@Component({
  selector: "app-homogenous-rainfall-map-daily",
  templateUrl: "./homogenous-rainfall-map-daily.component.html",
  styleUrls: ["./homogenous-rainfall-map-daily.component.css"],
})
export class HomogenousRainfallMapDailyComponent {
  regiondatacum: any[] = [];
  countrydatacum: any;
  countryActual: any;
  countryNormal: any;
  ...
  // as the REGION branch in rainfall-statistics.component.ts). To revert
  ...
  async loadStats() {
    ...
    try {
      await this.regionStatisticsDownload.updateandViewpdfFromDataEntryCustom(this.fromDate, this.fromDate);
