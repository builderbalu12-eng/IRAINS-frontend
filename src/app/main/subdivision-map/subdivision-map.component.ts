...
@Component({
  selector: "app-subdivision-map",
  templateUrl: "./subdivision-map.component.html",
  styleUrls: ["./subdivision-map.component.css"],
})
export class SubdivisionMapComponent {
  ...
  async downloadMapData() {
    ...
    try {
      this.isLoading = true;
      await this.downlaodStatistics.updateanddownloadpdfFromDataEntry();
