...
export class ComparisonComponent implements OnInit {
  ...
  //     center: [20.5937, 78.9629],
  //     zoom: 6,
  //     scrollWheelZoom: false,      // enable scroll
  //     zoomDelta: 0.25,            // finer zoom increments
  //     zoomSnap: 0,                // allow fractional zoom levels
  //     wheelPxPerZoomLevel: 120    // slows sensitivity if needed
  //   });
  ...
  const satelliteLayer = L.tileLayer(
    ...
    { attribution: '© <a href="https://www.google.com/maps">Google Maps</a>', maxZoom: 19 }
  );
  ...
  // Initialize layers control with base layers
  const baseLayers = {
    'Satellite': satelliteLayer,
    'White': whiteLayer
  };

  // Overlays will be added later (e.g., GeoJSON layers)
  const overlays = {};

  // Add layers control to map at top right (same as React example)
