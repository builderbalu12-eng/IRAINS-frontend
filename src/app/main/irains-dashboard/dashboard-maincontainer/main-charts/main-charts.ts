...
export class MainChartsComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    ...
    // Initialize skeleton chart
    const skeletonStart = new Date(this.startDate);
    const skeletonEnd = new Date(this.endDate);
    this.graphData.date = this.getDateRange(skeletonStart, skeletonEnd);
