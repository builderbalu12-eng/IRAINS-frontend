...
@Component({
  selector: 'app-subdivision-actual-map-dup',
  templateUrl: './subdivision-actual-map-dup.component.html',
  styleUrls: ['./subdivision-actual-map-dup.component.css']
})
export class SubdivisionActualMapDupComponent {
  ...
  private initMap(): void {
    this.map = L.map("map-actual-subdivision-ftp", {
      center: [24, 81.9629],
