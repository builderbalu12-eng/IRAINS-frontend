...
@Component({
  selector: 'app-region-actual-map-dup',
  templateUrl: './region-actual-map-dup.component.html',
  styleUrls: ['./region-actual-map-dup.component.css']
})
export class RegionActualMapDupComponent {
  ...
  async downloadMapData() {
    ...
    try {
      this.isLoading = true;
      await this.regionStatisticsDownload.updateanddownloadpdf();
  ...
  //   {
  //     color: "#277620",
  //     text: `Very Light Rainfall <br>[0.1mm to 15.5mm]`,
  //     fontSize: "10.4px",
  //   },
  //   { color: "#1f9ee7", text: "Light Rainfall <br>[15.6mm to 64.4mm]", fontSize: "10.4px" },
  //   { color: "#f3e821", text: "Moderate Rainfall <br>[64.5mm to 115.5mm]", fontSize: "10.4px" },
  //   {
  //     color: "#ff8b00",
  //     text: "Heavy Rainfall <br>[115.6mm to 204.4mm]",
  //     fontSize: "10.4px",
  //   },
  //   {
  //     color: "#da1b1e",
  //     text: "Very Heavy Rainfall <br>[>=204.5mm]",
  //     fontSize: "10.4px",
  //   },
  // ];
  ...
  private initMap(): void {
    this.map = L.map("map-actual-region-ftp", {
      center: [24, 81.9629],
