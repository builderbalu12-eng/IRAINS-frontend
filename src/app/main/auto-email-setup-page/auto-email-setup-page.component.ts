...
@Component({
  selector: 'app-auto-email-setup-page',
  templateUrl: './auto-email-setup-page.component.html',
  styleUrls: ['./auto-email-setup-page.component.css']
})
export class AutoEmailSetupPageComponent  implements OnInit{
