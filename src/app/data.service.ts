...
export class DataService {
  ...
  private selectdatamode = new BehaviorSubject<string>('');
  public selectdatamode$ = this.selectdatamode.asObservable();
  setDataMode(mode: string) {
    this.selectdatamode.next(mode);
  }

  private selectMode = new BehaviorSubject<string>('');
  public selectedMode$ = this.selectMode.asObservable();
